...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Xml ID="xml5" runat="server" DocumentSource="~/sugupuu_ylesanne/sugupuu.xml" TransformSource="~/sugupuu_ylesanne/vanem
			.xslt"></asp:Xml>
        </div>
...
TransformSource="~/sugupuu_ylesanne/otsi.xslt" />
 </pre>
            Otsitav tekst:
